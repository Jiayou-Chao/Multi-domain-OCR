...
TASK_ID = 0
work_dir = "work_dirs/backbone_docu_car_syn"
train_mode = "full"
NUM_CLASSES = [11378]
...
train_list = [
    _base_.document_textrecog_train,
    _base_.car_textrecog_train,
    _base_.syn_textrecog_train,
]
test_list = [
    _base_.document_textrecog_test,
    _base_.car_textrecog_test,
    _base_.syn_textrecog_test,
]
...
val_evaluator = dict(dataset_prefixes=["document", "car", "syn"])
