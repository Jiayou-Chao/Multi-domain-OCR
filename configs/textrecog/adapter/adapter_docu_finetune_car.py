...
TASK_ID = 0
load_from = "work_dirs/backbone_docu/epoch_20.pth"
work_dir = "work_dirs/backbone_docu_finetune_car"
train_mode = "full"
...
train_list = [_base_.car_textrecog_train]
test_list = [_base_.car_textrecog_test]
...
val_evaluator = dict(dataset_prefixes=["car"])
